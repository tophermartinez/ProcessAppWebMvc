...
namespace Entity_Layer
{
    public class Funcionario
    {
        ...
        public bool IngresaFuncionario()
        {
            ...
            //   ConexionEntity.ModelProcess.FUNCIONARIO_INS(Idfuncionario, Rut, Dv, Pnombre, Snombre, Apaterno, Amaterno, Telefono, Correo, Direccion, Unidad_Idunidad);
           // ConexionEntity.ProcessModelo.FUNCIONARIO_TAPI_INS(Idfuncionario, Rut, Dv, Pnombre, Snombre, Apaterno, Amaterno, Telefono, Correo, Direccion, Unidad_Idunidad);
